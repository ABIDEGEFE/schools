...
# Allow React frontend (add both common dev ports)
...
TEMPLATES[0]['DIRS'] = [os.path.join(BASE_DIR, 'project', 'build')]
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'project', 'build', 'static'),
]
STATIC_URL = 'static/'
...
# Allow all origins in development if you prefer (uncomment to enable)
